...
return [
    ...
    'latin'                          => ':attribute فقط می‌تواند شامل حروف الفبای لاتین باشد.',
    ...
    'dimensions'                     => ':attribute دارای ابعاد نامعتبر است.',
    ...
    'gte'                            => [
        ...
        'string'  => ':attribute باید بزرگ‌تر یا برابر با :value کاراکتر باشد.',
    ...
    'required_if'                    => 'فیلد :attribute زمانی که :other مقدار :value دارد الزامی است.',
    ...
    'reserved_word'                  => ':attribute شامل یک کلمه رزرو شده است.',
    'dont_allow_first_letter_number' => 'فیلد \":input\" نمی‌تواند با عدد شروع شود.',
    'exceeds_maximum_number'         => ':attribute حداکثر طول مجاز را رد کرده است.',
    'attributes'                     => [],
];
